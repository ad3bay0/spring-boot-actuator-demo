package com.ad3bay0.actuator.actuatordemo;
...
public class DemoApplicationTests {
    ...
    ResponseEntity<Map> entity = this.testRestTemplate.getForEntity("http://localhost:"+this.mgtPort+"/actuator/health", Map.class);
